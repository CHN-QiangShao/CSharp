...
![image-20230729000831738](C:\Users\JeylenBrown\AppData\Roaming\Typora\typora-user-images\image-20230729000831738.png)
...
![image-20230729002145442](C:\Users\JeylenBrown\AppData\Roaming\Typora\typora-user-images\image-20230729002145442.png)

④ 按如下图所示填写相关信息 -> 下一步。

![image-20230816032611025](C:\Users\JeylenBrown\AppData\Roaming\Typora\typora-user-images\image-20230816032611025.png)

假如将项目名用中文命名，后续会出现如下图情况。

![image-20230816031939343](C:\Users\JeylenBrown\AppData\Roaming\Typora\typora-user-images\image-20230816031939343.png)

假如将解决方案和项目放在同一目录中，如下图。

![image-20230729014305437](C:\Users\JeylenBrown\AppData\Roaming\Typora\typora-user-images\image-20230729014305437.png)
...
![image-20230816033506560](C:\Users\JeylenBrown\AppData\Roaming\Typora\typora-user-images\image-20230816033506560.png)

- .vs 文件夹存放工程的相关配置
- HelloWorld 工程文件夹存放编译的产生的可执行文件 bin 、编译产生的中间文件 obj 、**项目名 .csproj 的原生工程文件 **和 **若干个 类名.cs 的 C# 源代码文件**

![image-20230816035348732](C:\Users\JeylenBrown\AppData\Roaming\Typora\typora-user-images\image-20230816035348732.png)
...
- **解决方案名.sln 是解决方案文件**，解决方案资源管理器可以在菜单栏**视图**打开：
  ...
  - 可以管理多个工程项目，如果要在该解决方案添加新的工程，则直接右击解决方案->添加->新建项目，而不是在菜单栏上的文件->新建->项目。
    ...
    ![image-20230816050759205](C:\Users\JeylenBrown\AppData\Roaming\Typora\typora-user-images\image-20230816050759205.png)
    
    ![image-20230816050648749](C:\Users\JeylenBrown\AppData\Roaming\Typora\typora-user-images\image-20230816050648749.png)
    
    ![image-20230816050928808](C:\Users\JeylenBrown\AppData\Roaming\Typora\typora-user-images\image-20230816050928808.png)

### 1.4.2. 编译和运行

点击 Run 按钮或者按下 Ctrl+F5 键运行程序，会出现一个命令提示符窗口（Command Prompt window），显示 Hello World。并且在项目目录的 bin 目录下生成 项目名.exe 可执行文件。

![image-20230816035948852](C:\Users\JeylenBrown\AppData\Roaming\Typora\typora-user-images\image-20230816035948852.png)
...
- 搜索`行号`，显示行号。
  ...
  ![企业微信截图_16921331854431](C:\Users\JeylenBrown\AppData\Local\Temp\企业微信截图_16921331854431.png)

- 搜索`字体和颜色`，按如下图设置。

  ![image-20230730012927851](C:\Users\JeylenBrown\AppData\Roaming\Typora\typora-user-images\image-20230730012927851.png)

如果把设置调乱，在工具 -> 导入和导出设置 -> 重置所有设置即可，类似手机的恢复出厂设置。

![image-20230730013704012](C:\Users\JeylenBrown\AppData\Roaming\Typora\typora-user-images\image-20230730013704012.png)

- 启动项设置：设置为当前选定内容进行编译。![image-20230730014348784](C:\Users\JeylenBrown\AppData\Roaming\Typora\typora-user-images\image-20230730014348784.png)
